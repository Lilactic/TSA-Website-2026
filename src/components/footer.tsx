    ...
    <footer className={styles.footer}>
      <div className={styles.topSection}>
        <div className={styles.footerColumn}>
          ...
          <h3 className='whiteInterText' style={{marginTop: "4px", marginBottom: "24px"}}>For TSA 2026</h3>
        ...
        <div className={styles.footerColumn2}>
          <h2 className='whiteInterHeader'>Directory</h2>
        ...
        <div className={styles.footerColumn2}>
          <h2 className='whiteInterHeader'>Legal</h2>
          <Link className={styles.footerLink} to="/references"><h3 className='interText'>References</h3></Link>
          <Link className={styles.footerLink} to="/contact-us"><h3 className='interText'>Contact Us</h3></Link>
        </div>
      </div>
      <div className={styles.bottomSection}>
        <h2 className='whiteInterText'>© 2026 Friendswood Resources. All rights reserved.</h2>
      </div>
    </footer>
  )
}
